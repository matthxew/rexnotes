...
function About() {
  return (
    <main className="shell about fade-in">
      ...
      <p className="about-note">A note on the illustrations: paleontology keeps moving. Colours, postures, even feathers shift as new fossils turn up. The drawings here are our best interpretation from what we know today, not the final entry.</p>
