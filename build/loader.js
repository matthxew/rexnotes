document.addEventListener('DOMContentLoaded', async function() {
  ...
  window.addEventListener('error', function(e) {
    // Ignore resource-load errors (script/img/link 404s) — they have a DOM
    // target rather than window and no message string. Third-party scripts
    // like analytics shouldn't masquerade as bundle failures.
    if (e.target && e.target !== window && !e.message) return;
